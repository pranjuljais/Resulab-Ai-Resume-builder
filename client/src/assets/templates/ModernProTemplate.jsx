    ...
    <div className="max-w-5xl mx-auto bg-white text-zinc-800 py-3 m-0">
      <header className="flex border-b border-gray-300">
        <div className="w-1/4 shrink-0 px-6 py-2">
          <div className="w-28 h-28 overflow-hidden rounded-md shadow-md">
            {data.personal_info?.image ? (
              ...
              <div className="w-full h-full flex items-center justify-center text-[10px] text-gray-400 uppercase tracking-widest text-center px-2">
                Photo
              </div>
            )}
          </div>
        ...
        <div className="flex flex-col justify-center w-3/4 py-4 pr-6">
          <h1
            className="text-4xl font-bold text-gray-900 mb-0.5"
          ...
          <div className="flex flex-wrap items-center gap-x-4 text-sm text-gray-600 border-t border-gray-200 pt-2">
            ...
            {data.personal_info?.Network && (
              <a
                target="_blank"
                href={
                  data.personal_info?.Network.startsWith("https://")
                    ? data.personal_info?.Network
                    : `https://${data.personal_info?.Network}`
                }
                rel="noopener noreferrer"
                className="flex items-center gap-1"
              >
                <Network size={14} style={{ color: accentColor }} />
                <span className="truncate">
                  {data.personal_info.Network.split("https://")[1]
                    ? data.personal_info.Network.split("https://")[1]
                    : data.personal_info.Network}
                </span>
              </a>
